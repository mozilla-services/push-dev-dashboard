...
var ga_filename = document.getElementById('push-dashboard').dataset.ga_filename;

if (ga_id && ga_filename) {
    ...
    })(window,document,'script','//www.google-analytics.com/' + ga_filename,'ga');
...
(function(win, doc, $) {
    ...
    var analytics = win.dashboard.analytics = {
        /*
        ...
        */
        ...
        trackLink: function(event, url, data) {
            ...
            if(newTab || isAnchor) {
                ...
                analytics.trackEvent(data, function() {
                    window.location = url;
                });
            }
        },
